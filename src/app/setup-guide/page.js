      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="mt-8 bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="mt-4 mb-4">
            <div className="max-w-4xl mx-auto border border-gray-200 rounded-lg shadow-md overflow-hidden">
              <Image
                src="/ytai/images/guide/createapikeybutton.png"
        ...
        <div className="mt-8 bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="mt-4 mb-4">
            <div className="max-w-4xl mx-auto border border-gray-200 rounded-lg shadow-md overflow-hidden">
              <Image
                src="/ytai/images/guide/copyapikeybutton.png"
        ...
        <div className="mt-8 bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="mt-4 mb-4">
            <div className="max-w-4xl mx-auto border border-gray-200 rounded-lg shadow-md overflow-hidden">
              <Image
                src="/ytai/images/guide/extensionpinning.png"
        ...
        <div className="mt-8 bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="mt-4 mb-4">
            <div className="max-w-4xl mx-auto border border-gray-200 rounded-lg shadow-md overflow-hidden">
              <Image
                src="/ytai/images/guide/pasteinfactcheckerextension.png"
        ...
        <div className="mt-8 bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="mt-4 mb-4">
            <div className="max-w-4xl mx-auto border border-gray-200 rounded-lg shadow-md overflow-hidden">
              <Image
                src="/ytai/images/guide/extensionhowtouse.png"
